...
if [ $(id -u) == 0 ] ; then
    ...
    #export PS1='[\[\033[01;31m\]\u\[\033[01;33m\]@\[\033[01;36m\]\h\[$NC\]]:(\[$LG\]\[$BN\]\[$DS\]$($DFSCRIPT)\[$NC\]) \[\033[01;33m\]\w \[\033[01;35m\]\$ \[\033[00m\]'
    export PS1='\[$Reset\][\[$Red\]\u\[$Yellow\]@\[$Blue_1\]\h\[$Reset\]]:(\[$Blue_2\]$($DFSCRIPT)\[$Reset\]) \[$Yellow\]\w \[$Purple\]\$ \[$Reset\]'
else
    #DG="$(tput bold;tput setaf 0)";LG="$(tput setaf 6)";DS="$(tput setaf 2)";NC="$(tput sgr0)"
